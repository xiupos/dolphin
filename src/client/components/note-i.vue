...
>
	...
	<!-- Instagramized article -->
	<article class="article">
		<div class="header">
			<dp-avatar class="avatar" :user="appearNote.user"/>
			<x-note-author class="author" :note="appearNote" :mini="true"/>
			<button class="menu button _button" @click="menu()" ref="menuButton">
				<fa :icon="faEllipsisH"/>
			</button>
		</div>
		<div class="media">
		...
		<div class="footer">
			<x-note-date class="date" :note="appearNote" :mini="true"/>
		</div>
	</article>
...
import XNoteAuthor from './note-author.vue';
import XNoteDate from './note-date.vue';
...
.note {
	...
	> .article {
		display: grid;
		grid-template-rows: 70px 1fr min-content min-content;
